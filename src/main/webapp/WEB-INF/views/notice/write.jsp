        ...
        <div class="col-md-12">
          ...
          <div class="card card-primary">
            <div class="card-header">
              <h3 class="card-title">Notice Register</h3>
            </div>
            <!-- /.card-header -->
            <!-- form start -->
            <form id="form1" action="/notice/write" method="post">
              <div class="card-body">
                <div class="form-group">
                  ...
                  <input type="text" name="noticeTitle" class="form-control" id="exampleInputEmail1" placeholder="Enter Title">
                </div>
                <div class="row">
                  <div class="col-sm-12">
                    <!-- textarea -->
                    <div class="form-group">
                      ...
                      <textarea name="noticeContent" class="form-control" rows="3" placeholder="Enter ..."></textarea>
                    </div>
                  </div>
                </div>
              </div>
